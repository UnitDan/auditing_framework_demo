...
class GradiantBasedSeeker(Seeker, metaclass=ABCMeta):
    ...
    def seek(self, lamb, origin_lr, max_query, init_sample=None):
        self.n_query = 0
        ...
        x0, delta_t, x_t, pred_t, lr = init(init_sample)
        # print(x0)
...
class BlackboxSeeker(GradiantBasedSeeker):
    def __init__(self, model, unfair_metric: UnfairMetric, data_gen: DataGenerator, g_range=1e-1):
